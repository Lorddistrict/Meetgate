 ...
 */
final class Version20190624135425 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE user 
            ...
            CHANGE certified_token certified_token VARCHAR(255) DEFAULT NULL, 
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE user 
            ...
            CHANGE certified_token certified_token VARCHAR(255) DEFAULT \'NULL\' COLLATE utf8mb4_unicode_ci, 
